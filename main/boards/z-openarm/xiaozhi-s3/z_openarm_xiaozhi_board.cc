...
#define TAG "ZOpenArmXiaozhi"

class ZOpenArmXiaozhiBoard : public WifiBoard {
private:
    ...
    void InitializeDisplay() {
        ...
        display_ = new OledDisplay(
            panel_io_, panel_, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_MIRROR_X, DISPLAY_MIRROR_Y);
    }
...
DECLARE_BOARD(ZOpenArmXiaozhiBoard);
